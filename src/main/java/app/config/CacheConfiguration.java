...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(app.domain.SocialUserConnection.class.getName(), jcacheConfiguration);
            cm.createCache(app.domain.Location.class.getName(), jcacheConfiguration);
            cm.createCache(app.domain.Location.class.getName() + ".posters", jcacheConfiguration);
            cm.createCache(app.domain.Poster.class.getName(), jcacheConfiguration);
